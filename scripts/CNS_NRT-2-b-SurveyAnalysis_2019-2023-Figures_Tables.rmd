...
```{r Table6-responses_stats_role, echo=FALSE, paged.print=TRUE}
# By Role
...
```{r Figure5-CNS_NRT-goals, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=2.5, fig.width=10, message=FALSE, warning=FALSE, echo=FALSE}
#### Overall
...
```{r Figure6-CNS_NRT-goals-role, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=8, fig.width=10, message=FALSE, warning=FALSE, echo=FALSE}
#### Role Level
...
```{r Figure14-CNS_NRT-covidimpact, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=4.5, fig.width=6, message=FALSE, warning=FALSE, echo=FALSE}
#### Overall
# Annual count of distinct participants for each year
participant_ct <- 
  d_all %>% 
...
```{r Table7-nrt-sat1, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Figure7-CNS_NRT-DoctoralFellow-Satisfaction, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=4.5, fig.width=7.5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Table8-nrt-skills1, echo=FALSE, message=FALSE, warning=FALSE}
tmp <-
  d_std %>% 
...
```{r Figure8-CNS-NRT_DoctoralFellow-ProgramImpactSkills, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=4.5, fig.width=7.5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Table9-nrt-mentF1, echo=FALSE, message=FALSE, warning=FALSE}
tmp <-
  d_fac %>%
  filter(Value!="Not Applicable") %>%
  group_by(Item) %>%
...
```{r Figure11-CNS_NRT-Faculty-Mentoship, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=4.5, fig.width=6,  message=FALSE, warning=FALSE, echo=FALSE}
...
```{r Table10-nrt-mentS1, echo=FALSE, message=FALSE, warning=FALSE}
tmp <-
  d_std %>% 
...
```{r Figure12-CNS_NRT-DoctoralFellow_MentorshipImpact, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=5, fig.width=8, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r Table11-nrt-mentS3, echo=FALSE, message=FALSE, warning=FALSE}
# Student satisfaction questions
tmp <-
  d_std %>%  
  ...
  dplyr::summarise(Responses = n(),
                   ...
                   Mean = round(mean(as.numeric(Value)),1),
                   SD = round(sd(as.numeric(Value)),3))
write.csv(tmp,"../tables/Table11-CNS_NRT-Survey_2019-2023-DoctoralFellow_MentorshipQuality.csv",
          row.names = FALSE)
...
```{r Figure13-CNS_NRT-DoctoralFellow-MentorshipQuality, fig.path="../figures/", dpi=200, dev=c('png','tiff'), fig.height=6.5, fig.width=9, message=FALSE, warning=FALSE, echo=FALSE}
# Fellows Participants - Mentorship Impact on Research Skills
participant_ct <- 
  d_std %>% 
  select(Year, Role, ResponseId) %>% 
...
```{r Figure9-CNS_NRT-DoctoralFellow-ProgramImpact-Interdisciplinary, fig.path="../figures/", dpi=200,  dev=c('png','tiff'),  fig.height=2.5, fig.width=8, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r Figure10-CNS_NRT-DoctoralFellow-Interdisciplinary, fig.path="../figures/", dpi=200,  dev=c('png','tiff'), fig.height=9.5, fig.width=7.5, message=FALSE, warning=FALSE, echo=FALSE}
